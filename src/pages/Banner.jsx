              ...
              <div className="row banner-top">
                ...
                <div className="col-lg-8 p-0 banner-top-right">
                  ...
                  <div className='banner-img'>
                    <img src={car.bannerImg} alt="" className={`img-fluid ${video? undefined: 'active'}`} />
                    <video className={`banner-video  ${video? 'active': undefined}`} 
                    src={car.video} autoPlay loop muted></video>
                    
                    <div className='car-brief'>
                      <div className='car-intro'>
                        <CircleBar name="Power" number={car.power} color="#f82249"/>

                        <CircleBar name="Engine" number={car.engine} color="#1865ff"/>

                        <CircleBar name="New" number={car.new} color="#5ff880"/>
                      </div>
                  ...
                  <div className='car-description'>
                    ...
                    <div className='car-features'>
                      ...
                      <Link to={`/vehicles/${car._id}`} className='detail-link text-center'>
                          Explore <i className='bi-arrow-right-short'></i>                      
                      </Link>
                    </div>
                  </div>
                </div>
